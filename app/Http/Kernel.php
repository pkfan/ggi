...
use App\Http\Middleware\CheckInsuranceCompany;
use App\Http\Middleware\CheckLawFirm;
use App\Http\Middleware\CheckFinanceCompany;
...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'CI' => CheckInsuranceCompany::class,
        'CA' => CheckAdmin::class,
        'CLF' => CheckLawFirm::class,
        'Fc'=>CheckFinanceCompany::class,
        'preventBackHistory' => \App\Http\Middleware\PreventBackHistory::class,
        // laratrust permissions middleware
