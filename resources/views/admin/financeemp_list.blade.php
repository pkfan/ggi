...
@section('title', 'Finance Employee List')
    ...
    <div class="app-content content ">
        ...
        <div class="content-wrapper container-xxl p-0">
            ...
            <div class="content-body">
                <div class="row">
                    <div class="col-12">
                        <h4>@lang('language.REGISTERED EMPLOYEES')
                            ...
                            <div class="card-header">
                                ...
                                <div class=" col-md-6  mb-1">
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <a href="{{ route('admin.add.finance-employee') }}"> <button type="button"
                                                class="btn btn-primary">Add Finance Employee</button></a>
                                                ...
                                                <td>
                                                    @if ($user->status == 0)
                                                        <a href="{{ url('admin/de-active/user/' . $user->id) }}"
                                                            class="btn btn-danger">@lang('language.Not Active')</a>
                                                    @else
                                                        <a href="{{ url('admin/active/user/' . $user->id) }}"
                                                            class="btn btn-success">@lang('language.Active')</a>
                                                    @endif
                                                </td>
                                                <td>
                                                    <a href="{{ url('admin/edit-finance-employee/' . $user->id) }}"
                                                        class="btn btn-outline-danger">@lang('language.Edit'')</a>
                                                </td>
                                            </tr>
                                            <?php
                                            $count++;
...
@push('finance-employee-list-css')
    <!-- BEGIN: Vendor CSS-->
