                            ...
                            <div class="card">
                                <div class="card-header" style="padding-top: 0;">
                                    ...
                                    <div
                                        ...
                                        <x-admin::claim.claim-detail-top-buttons-modals :claim="$claim" />
                                    </div>
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-md-8">
                                        <x-admin::claim.claim-detail-select-status :status="$status" :claim="$claim" />
                                    </div>
                                    <div class="container px-3 py-1">

                                        <x-admin::claim.status :status="$status" :claim="$claim" />
                                    </div>
                                    ...
                                    <x-admin::claim.claim-detail-table :status="$status" :claim="$claim" />
                                    ...
                                    <div class="row">
                                        ...
                                        <x-admin::claim.claim-detail-add-remarks :status="$status" :claim="$claim" />
                                        <br>
