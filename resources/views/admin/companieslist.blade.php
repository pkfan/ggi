                            ...
                            <div class="card-header">
                                ...
                                <div class=" col-md-6  mb-1">
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <a href="addcompany.html"> <button type="button" class="btn btn-primary"
                                                href="{{ route('admin.add.company') }}">Add Company</button></a>
                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" class="text-nowrap">Company Type </th>
                                            <th scope="col" class="text-nowrap">Mobile Number</th>
                                            <th scope="col" class="text-nowrap">Upload Document </th>
                                            <th scope="col" class="text-nowrap">Registered Date</th>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($companies as $company)
                                            <tr>
                                                ...
                                                <td><a href="{{ asset('storage/' . $company->document) }}">Document</a></td>
                                                <td>{{ $company->created_at }}</td>
                                                <td>
                                                    <a href="{{ url('admin/edit-company/' . $company->id) }}"
