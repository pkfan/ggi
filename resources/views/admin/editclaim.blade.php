                                ...
                                <div class="card-body">
                                    <form class="form" method="POST" action="{{ route('admin.claim.update') }}"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    <label for="last-name-column">@lang('language.Our Responsibility Per') </label>
                                                    <select name="libpercent" id="" class="form-control">
                                                    <option value="{{ $claim->libpercent }}" selected>{{ $claim->libpercent }}</option>
                                            ...
                                            <div class="col-lg-6 col-md-12">
                                                <div class="form-group">
                                                    <label for="customFile">@lang('language.Survey Number')</label>
                                                    <input type="number" class="form-control" name="survey_number" value="{{$claim->claimData->survey_number}}">
