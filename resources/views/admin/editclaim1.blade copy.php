                                ...
                                <div class="card-body">
                                    <form class="form" method="POST" action="{{ route('admin.claim.update') }}"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="last-name-column" class="form-control"
                                                         name="claim_no"
                                                        value="{{ old('claim_no') ?? $claim->claim_no }}" />
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                            ...
                                            {{-- /////////////// --}}
                                            <div class="col-md-6 col-12">
                                                <label for="inputEmail" class="form-label">@lang('language.Type') <span class="text-danger">*</span></label>
                                                <div class="demo-inline-spacing form-control">
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" value="ind"
                                                                name="type"
                                                                aria-label="Radio button for following text input"
                                                                required @if ($claim->type == 'ind') checked @endif>
                                                        {{-- <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio1" value="option1" checked /> --}}
                                                        <label class="form-check-label rad" for="inlineRadio1">@lang('language.Ind')</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                                value="Corporate" name="type"
                                                                @if ($claim->type == 'Corporate') checked @endif
                                                                aria-label="Radio button for following text input"
                                                                required>
                                                        {{-- <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio1" value="option1" checked /> --}}
                                                        <label class="form-check-label rad" for="inlineRadio1">@lang('language.Corporate')</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            value="Leasing" name="type"
                                                            @if ($claim->type == 'Leasing') checked @endif
                                                            aria-label="Radio button for following text input"
                                                            required>
                                                        <label class="form-check-label rad" for="inlineRadio2">@lang('language.Leasing')</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            value="Government" name="type"
                                                            @if ($claim->type == 'Government') checked @endif
                                                            aria-label="Radio button for following text input"
                                                            required>
                                                        <label class="form-check-label rad " for="inlineRadio3">@lang('language.Government')</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            ...
                                                            aria-label="Radio button for following text input"
                                                            required>
                                                        <label class="form-check-label rad" for="inlineRadio4">@lang('language.Minuciplity')</label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 col-12" id="recoveryReason">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="rec_reason">
                                                        <option value='' disabled selected> @lang('language.Select Recovery Reason') </option>
                                                        <option value="عكس اتجاه السير">عكس اتجاه السير</option>
                                                        <option value="القيادة تحت تأثير المخدرات أو المشروبات الكحولية">القيادة تحت تأثير المخدرات أو المشروبات الكحولية</option>
                                                        <option value="لا يملك رخصة قيادة">لا يملك رخصة قيادة</option>
                                                        <option value="أنتهاء تاريخ رخصة القيادة">أنتهاء تاريخ رخصة القيادة</option>
                                                        <option value="صدم و هروب من موقع الحادث">صدم و هروب من موقع الحادث</option>
                                                        <option value="تجاوز الإشارة الحمراء">تجاوز الإشارة الحمراء</option>
                                                        <option value="وقوع الحادث عمدًا">وقوع الحادث عمدًا</option>
                                                        <option value="سرقة المركبة أو مأخوذة غصبًا يتم الرجوع على السائق">سرقة المركبة أو مأخوذة غصبًا يتم الرجوع على السائق</option>
                                                        <option value="لا يملك تأمين ساري">لا يملك تأمين ساري</option>
                                                        <option value="اخفاء حقيقة جوهرية / تبديل السائق وقت الحادث">اخفاء حقيقة جوهرية / تبديل السائق وقت الحادث</option>
                                                        <option value="اخفاء حقيقة جوهرية /حمولة زائدة تسببت بالحادث">اخفاء حقيقة جوهرية /حمولة زائدة تسببت بالحادث</option>
                                                        <option value="التفحيط">التفحيط</option>
                                                        <option value="تجاوز عدد الركاب المصرح به للمركبة">تجاوز عدد الركاب المصرح به للمركبة</option>
                                                        <option value="عمر السائق أقل من 18 عام وغير مذكور في الوثيقة">عمر السائق أقل من 18 عام وغير مذكور في الوثيقة</option>
                                                    ...
                                                    <div data-select2-id="187" class=" ">
                                                        <div class="position-relative " data-select2-id="186">
                                                            <select name='officer_id'
                                                                ...
                                                                <option value="{{$claim->officer?->id}}" data-select2-id="all">{{$claim->officer?->name}}</option>
                                            ...
                                            <input id="input-b3" name="support_doc[]" type="file" class="file"
                                                style="width: 100%;
                                            padding: 0 16px 32px;"
