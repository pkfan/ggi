    ...
    <div class="app-content content ">
        ...
        <div class="content-wrapper container-xxl p-0">
            ...
            <div class="content-body">
                <div class="row">
                    <div class="col-12">
                        <h4>@lang('language.CLAIM APPROVED')
                        ...
                        <div class="card">
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    <thead>
                                        <tr>
                                            <th scope="col" class="text-nowrap">@lang('language.ID')</th>
                ...
                {{--                                        <a href="{{url('make/call/'.$claim->id)}}"><i style="font-size:20px ;border:1px solid " class="bx bx-phone"></i></a>--}}

                                                        <a href="{{route('AdminClaimDetail',$claim->id)}}">
                                                            <button style=" width: 127px;" class="btn btn-outline-primary">View Detail</button>
