...
@section('title', 'Case Close Objection')
 ...
 <div class="app-content content ">
    ...
    <div class="content-wrapper container-xxl p-0">
        ...
        <div class="content-body">
            <div class="row">
                <div class="col-12">
                    <h4>@lang('language.Case Close Details')
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>Objection</td>
                                                <td><a href="{{url('admin/claim/detail/'.$obj->claim_id)}}" class="btn btn-outline-gradient" target="_blank">View Details</a></td>
