                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">
                                    ...
                                    Add {{$queryRole?->display_name ?? 'User'}}</h4>
                            </div>
                            <div class="card-body">
                                <form class="form" method="POST" action="{{route('admin.register.user')}}">
                                    @csrf
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-12">
                                            ...
                                            <div class="col-12" style="margin-top: 12px; border-top: 1px solid #c8c6c6; ">
                                                <div class="card">
                                                    <div class="card-header">
                                                            ...
                                                            @foreach ($roles as $role )
                                                                <div class="custom-control custom-control-success custom-checkbox">
                                                                    <input
                                                                        ...
                                                                        value="{{$role->name}}"
                                                                        id="{{$role->name}}-role"
                                                                        @if ($queryRole?->name == $role->name)
                                                                            checked
                                                                        @endif
                                                                        @if($queryRole && $queryRole?->name != $role->name)
                                                                            disabled
                                                                        @endif
                                                                    >
                                                                    <label class="custom-control-label" for="{{$role->name}}-role">{{$role->display_name}}</label>
                                                                </div>
                                                            @endforeach
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="col-12">
                                            <button type="submit" class="btn btn-primary mr-1">@lang('Language.Register')</button>
