                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" class="text-nowrap">Assign Firm</th>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach($response as $res)
                                            <tr>
                                                ...
                                                <td>{{companyname($res->claim_id)}}</td>
                                                <td>{{rescompany($res->claim_id)}}</td>

                                                @if($res->response==2)
                                                <td><span class="badge bg-danger">Refuse</span></td>
                                                @endif

                                                <td><a  class="btn btn-outline-success" href="{{url('admin/view/refuse/claim/detail/'.$res->claim_id)}}">Detail</a></td>
                                                <td>

                                                    @if( checkfirmassign($res->id)->obj_status==1)
                                                        <span class="badge bg-success">Assigned</span>
                                                    @else
                                                    <select class="form-control" name="firm" onchange="location = this.value;">
                                                        <option checked>Select Law Firm</option>
                                                        @foreach(getfirms() as $firm)
                                                    <option value="{{url('admin/assign/firm/'.$res->id.'/'.$firm->id)}}">{{$firm->name}}</option>
