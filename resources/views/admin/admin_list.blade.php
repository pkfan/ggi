    ...
    <div class="app-content content ">
        ...
        <div class="content-wrapper container-xxl p-0">
            ...
            <div class="content-body">
                <div class="row">
                    <div class="col-12">
                        <h4> @lang('language.REGISTERED USERS')
                            ...
                            <div class="card-header">
                                ...
                                <div class=" col-md-6  mb-1">
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <a href="{{url('admin/add/admin-staff')}}" class="btn btn-primary">Add Admin</a>
                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th> @lang('language.Mobile Number')</th>
                                            <th> @lang('language.National Id')</th>
                                            <th> @lang('language.Registered Date')</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php
                                    ...
                                    <tr>
                                        <td>{{$count}}</td>
                                        <td>{{$user->name}}@if($user->is_super==1)<sup style="color:blue">super</sup>@endif</td>
                                        <td>{{$user->email}}</td>
                                        <td>{{$user->phone}}</td>
                                        <td>{{$user->reg_no}}</td>
                                        <td>{{$user->created_at}}</td>
                                        <!-- <td>
                                            <a href="{{url('admin/edit-finance-employee/'.$user->id)}}" class="btn btn-outline-danger">Edit</a>
                                        </td> -->
                                    </tr>
                                        <?php
                                            $count++;
