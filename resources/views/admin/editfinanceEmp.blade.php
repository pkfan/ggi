...
@section('title', 'Edit Finance Emplayee')
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">@lang('language.Edit Company Employee')</h4>
                            </div>
                            <div class="card-body">
                                <form class="form">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group form-password-toggle mb-2">
                                                    <input type="password" class="form-control" id="basic-default-password" aria-describedby="basic-default-password" />
                                        ...
                                        <div class="col-12">
                                            <button type="update" class="btn btn-primary mr-1">@lang('language.Update')</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
...
@push('edit-finance-employee-css')
    <!-- BEGIN: Vendor CSS-->
