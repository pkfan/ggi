...
@section('title', 'Finance Company List')
    ...
    <div class="app-content content ">
        ...
        <div class="content-wrapper container-xxl p-0">
            ...
            <div class="content-body">
                <div class="row">
                    <div class="col-12">
                        <h4>@lang('language.REGISTERED COMPANIES')
                            ...
                            <div class="card-header">
                                ...
                                <div class=" col-md-6  mb-1">
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <a href="{{ route('admin.add.financial-company') }}"> <button type="button"
                                                class="btn btn-primary">Add
                                                Financial Company</button></a>
                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" class="text-nowrap">@lang('language.Upload Document') </th>
                                    ...
                                    <tbody>
                                        ...
                                        $count = 1;
                                        ?>
                                        @foreach ($financies as $company)
                                            <tr>
                                                <td>{{ $count }}</td>
                                                <td>{{ $company->name }}</td>
                                                <td>+966{{ $company->mobile_no }}</td>
                                                <td><a href="{{ $company->document }}">Document</a></td>
                                                <td>{{ $company->created_at }}</td>

                                                <td>
                                                    <a href="{{ url('admin/edit-finance-company/' . $company->id) }}"
