        ...
        <table class="table table-borderless" style=" border: 1px solid #e1e0e0;">
            ...
            <tbody style=" background: #f5f5f5;">
                ...
                <tr style="padding-left: 61px;">
                    ...
                    <td style="width: 200px; padding-left: 32px;">
                        <span class="font-weight-bolder">@lang('language.Our Responsibility Per')</span>
                    </td>
                    <td style="width: 200px; ">
                        <span
                ...
                <tr style="padding-left: 61px;">
                    ...
                    <td style="width: 200px; padding-left: 32px;">
                        <span class="font-weight-bolder">Survey Number</span>
                    </td>
                    <td style="width: 200px; ">
                        <span class="font-weight-bolder">{{ $claimData->survey_number }}</span>
                    </td>
                </tr>
