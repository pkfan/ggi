            ...
            <form action="{{route('admin.settings.role.update')}}" method="POST">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <input type="text" name='name' id="update-role-name" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <input type="text" name='display_name' id="update-role-display-name"  class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name='description' id="update-description" rows="3" ></textarea>
                    </div>
