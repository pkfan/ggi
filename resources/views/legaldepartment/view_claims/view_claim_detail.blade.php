                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header" style="padding-top: 0;">
                                ...
                                <div style="
                                        ...
                                        align-items: center;">
                                    <h4 class="mb-0 text-primary " style="  background: #037293;color: white!important;padding: 4px; text-align: center;  border-radius: 4px; margin-bottom: 22px!important;width: 100%;">
                                        Claim Detail - <span style="color: #ffff5a;">GGI00{{ $claim->id }}</span>
                                    </h4>

                                    <x-legal::claim.claim-detail-top-buttons-modals :claim="$claim" />
                                </div>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-md-8">
                                    <x-legal::claim.claim-detail-select-status :status="$status" :claim="$claim" />
                                </div>
                                ...
                                <div class="container px-3 py-1">
                                    ...
                                    <x-legal::claim.status :status="$status" :claim="$claim" />
                                </div>
                                ...
                                <x-legal::claim.claim-detail-table :status="$status" :claim="$claim" />
                                <input type="hidden" name="rec_amt" id="rec_amt" value="{{ $claim->amount_after_discount }}" />
                        ...
                        <h4>end of card error test</h4> --}}
                                ...
                                <!-- <div class="col-12">
                                    <div class="alert alert-warning" role="alert" style="padding: 8px;margin-top: 4px;">
                                        <svg stroke="currentColor" fill="currentColor" stroke-width="0" version="1.1" viewBox="0 0 16 16" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <br>
                                            please upload supportive or additinal docs to (<span style="color:rgb(0, 90, 0); font-weight:bolder">APPROVE</span>)
                                            this
                                            claim
                                        </span>
                                    </div>
                                ...
                                @endif
                                @if(hasDocumentCompelete($claim->id) == \App\Enums\LegalDepartmentStatus::APPROVE->value)
                                @if(!$hasAdditionalDetail)
                                <div class="divider" style=" width: 100%;">
                                    <div class="divider-text">Add Additional Details</div>
                                </div>
                                <div class="container-fluid">
                                    <form action="{{route('legaldepartment.additional-detail')}}" method="post">
                                        @csrf
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="reference_no">Date & Time.</label>
                                                    <input type="datetime-local" class="form-control" name="date_time" placeholder="YYYY-MM-DD HH:MM">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <button type="submit" id="add_additional_detail" class="btn btn-primary float-left mt-2">Submit</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                                @endif
                                @endif
                                @if(hasDocumentCompelete($claim->id) == \App\Enums\LegalDepartmentStatus::PENDING->value)
                                <div class="col-12">
                                    <div class="alert alert-warning" role="alert" style="padding: 8px;margin-top: 4px;">
                                        <svg stroke="currentColor" fill="currentColor" stroke-width="0" version="1.1" viewBox="0 0 16 16" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M8 1.45l6.705 13.363h-13.409l6.705-13.363zM8 0c-0.345 0-0.69 0.233-0.951 0.698l-6.829 13.611c-0.523 0.93-0.078 1.691 0.989 1.691h13.583c1.067 0 1.512-0.761 0.989-1.691h0l-6.829-13.611c-0.262-0.465-0.606-0.698-0.951-0.698v0z">
                                            ...
                                            If claim has complete docs then (<span style="color:rgb(0, 90, 0); font-weight:bolder">APPROVE</span>)
                                ...
                                <div class="divider" style=" width: 100%;">
                                    <div class="divider-text">Court verdict issue</div>
                                </div>
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <p>Court verdict issued ?</p>
                                            <a href="{{route('legaldepartment.court-verdict-issued', ['id' => $claim->id,'status'=>'yes'])}}" class="btn btn-outline-success">
                                                Yes
                                            </a>
                                            <a href="{{route('legaldepartment.court-verdict-issued', ['id' => $claim->id, 'status'=>'no'])}}" class="btn btn-outline-danger">
                                                No
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="modal-footer">
                                    @if(hasDocumentCompelete($claim->id) == \App\Enums\LegalDepartmentStatus::PENDING->value)
                                    <a href="{{route('legaldepartment.docs-compelete', ['id' => $claim->id])}}">
                                    ...
                                    <!-- <a href="@if (request()->is('officer/*')) {{ route('officer.edit-claim.id', ['id' => $claim->id]) }}
                                            @elseif (request()->is('supervisor/*'))
                                                {{ route('supervisor.edit-claim.id', ['id' => $claim->id]) }}
                                            @else
                                                {{ route('admin.edit-claim.id', ['id' => $claim->id]) }} @endif"
                                    ...
                                    <!-- <div class="modal fade text-left modal-primary" id="additionalDetails" tabindex="-1" role="dialog" aria-labelledby="myModalLabel160" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="myModalLabel160">Addion the
                                                        claim
                                                    </h5>
                                    ...
                                    <button type="button" class="btn btn-outline-danger" data-toggle="modal" data-target="#rejectClaim">
                                        Reject
                                    </button>
                                    <div class="modal fade text-left modal-primary" id="rejectClaim" tabindex="-1" role="dialog" aria-labelledby="myModalLabel160" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('AdminRejectClaim') }}" method="post" enctype="multipart/form-data">
                                                        <div class="mb-3">
                                                            <h4>GGI00{{ $claim->id }}</h4>
                                                            @csrf
                                                            <input type="hidden" name="id" id="claimid" value="{{ $claim->id }}">
                                                            <div class="mb-3">

                                                                <label for="user-current-role" class="form-label">Rejection Reason</label>
                                    ...
                                    <form action="{{ route('AdminToggleClaimStatus') }}" method="post">
                                        ...
                                        @if ($hasSupportiveDoc || $hasAdditionalDoc)
                                        <button class="btn btn-outline-success" style="margin-left:5px">@lang('language.Approve')</button>
                                        @endif
                                    </form>
                                    ...
                                    <button type="button" class="btn btn-danger" data-dismiss="modal">@lang('language.Rejected')</button>
                                    @endif

                                    @permission('add-additional-document')
                                    <div class="d-inline-block">
                                        Button trigger modal -->
                                    <button type="button" class="btn btn-outline-dark" data-toggle="modal" data-target="#primary">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="mb-3">
                                                        <h4>GGI00{{ $claim->id }}</h4>
                                                        <form action="{{ url('admin/additional-document') }}" method="post" enctype="multipart/form-data">
                                                            @csrf
                                                            <div class="mb-3">
