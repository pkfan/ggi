    ...
    <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
        ...
        <li class=" nav-item @if (request()->routeIs([
            ...
            <ul class="menu-content">
                <li><a class="d-flex align-items-center @if (request()->routeIs('legaldepartment.claims')) active @endif"
                        href="{{ route('legaldepartment.claims') }}"><i data-feather="circle"></i><span
