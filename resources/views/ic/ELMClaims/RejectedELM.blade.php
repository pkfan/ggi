    ...
    <div class="app-content content ">
        <div class="page-wrapper">
            <div class="page-content">
                <h6 class="mb-0 text-uppercase">Rejected ELM</h6>
                <hr>
                <div class="card">
                    <div class="card-body">
                        <div class="table-responsive">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        <div id="example2_filter" class="dataTables_filter">
                                            <label>Search:<input type="search" class="form-control form-control-sm" aria-controls="example2"></label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <tr role="row">
                                ...
                                <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Accident Location: activate to sort column ascending" style="width: 211.656px;">Debtor Type</th>
                                ...
                                @if (count($claims) > 0)
                                    @foreach($claims as $claim)
                                       <tr role="row" class="odd">
                                            ...
                                            <td>{{getCompanyById($claim->cid)->name}}</td>
