    ...
    <div class="app-content content ">
        <div class="page-wrapper">
            <div class="page-content">
                <h6 class="mb-0 text-uppercase">Valid Objection</h6>
                <hr>
                <div class="card">
                    <div class="card-body">
                        <div class="table-responsive">
                            <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                                ...
                                <thead>
                            <tr role="row">
                                <th class="sorting_asc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-sort="ascending" aria-label="ID: activate to sort column descending" style="width: 91.5312px;">Claim ID</th>
                                ...
                                <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Recovery Amount: activate to sort column ascending" style="width: 207.109px;">Response</th>
                                <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Accident Date: activate to sort column ascending" style="width: 167.125px;">Detail</th>
                                <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Accident Location: activate to sort column ascending" style="width: 211.656px;">Action</th>
                            </tr>
                                </thead>
                                    <tbody>
                                    @foreach($objection as $obj)
                                       <tr role="row" class="odd">
                                            <td class="sorting_1">GGI00{{$obj->claim_id}}</td>
