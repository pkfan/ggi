        ...
        <div class="content-wrapper container-xxl p-0">
            ...
            <div class="content-body">
                ...
                <div class="row" id="basic-table">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header justify-content-end mb-1">
                                <div class="col-12 d-flex justify-content-end">
                                    <form method="GET"
                                        action="@if(request()->is('admin/*')) {{route('admin.claims.discount.history')}} @else {{route('supervisor.claims.discount.history')}} @endif">
                                            ...
                                            <div data-select2-id="187" class=" ">
                                                <div class="position-relative " data-select2-id="186" style=" width: 240px; border: 1px solid #82868b;border-radius: 4px;">
                                                    <select name='officer_id' class=" select2 btn btn-outline-secondary btn-sm waves-effect form-control select2-hidden-accessible dropdown-toggle" data-select2-id="16"
                                                        ...
                                                        <option value="" data-select2-id="all">all officers</option>
                                                        @php
                                    ...
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col" class="text-nowrap"
                                                    style="background-color: #6c6c6c;color: white;">Officer</th>
                                                <th scope="col" class="text-nowrap"
