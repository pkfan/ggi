                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex" style="justify-content:space-between">
                                            ...
                                            <span class="bg-primary p-2 mt-3 text-light rounded">Collected</span>
                                            @elseif(claimstatus($claim->id) == 3)
                                            <span class="bg-primary p-2 mt-3 text-light rounded">Delay
                                                Payment</span>
                                            @elseif(claimstatus($claim->id) == 4)
                                            <span class="bg-primary p-2 mt-3 text-light rounded">Partial
                                                Payment</span>
                                            @elseif(claimstatus($claim->id) == 5)
                                            <span class="bg-primary p-2 mt-3 text-light rounded">Transfer to
                                                Morror</span>
                                            @elseif(claimstatus($claim->id) == 6)
                                            <span class="bg-primary p-2 mt-3 text-light rounded">Transfered To
                                                Lawyer</span>
                                            @elseif(claimstatus($claim->id) == 7)
                                            <span class="bg-primary p-2 mt-3 text-light rounded">Transfer To Finance
                                                Co.</span>
                                            ...
                                            <span class="bg-primary p-2 mt-3 text-light rounded">Close</span>
                                            @elseif(claimstatus($claim->id) == 11)
                                            <span class="bg-primary p-2 mt-3 text-light rounded">Registered</span>
                                            @elseif(claimstatus($claim->id) == 12)
                                            <span class="bg-danger p-2 mt-3 text-light rounded">Closed</span>
                                            @elseif(claimstatus($claim->id) == 13)
                                            <span class="bg-success p-2 mt-3 text-light rounded">Collected</span>
                                            @elseif(claimstatus($claim->id) == 14)
                                            <span class="bg-danger p-2 mt-3 text-light rounded">Objection</span>
                                            @elseif(claimstatus($claim->id) == 15)
                                            <span class="bg-danger p-2 mt-3 text-light rounded">Refused</span>
                                            @elseif(claimstatus($claim->id) == 16)
                                            <!--direct pay-->
                                            <span class="bg-danger p-2 mt-3 text-light rounded">Collected</span>
                                            ...
                                            <span class="bg-danger p-2 mt-3 text-light rounded">Rejected</span>
                                            @elseif(claimstatus($claim->id) == 1)
                                            <span class="bg-secondary p-2 mt-3 text-light rounded">Follow up</span>
                                            @elseif(claimstatus($claim->id) == 19)
                                            <span class="bg-success p-2 mt-3 text-light rounded">Collected By
                                                Insurance</span>
                                            @elseif(claimstatus($claim->id) == 21)
                                            <span class="badge badge-primary" style="padding: 7px;">Send to collection office
                                            </span>
                                            @else
                                        ...
                                        @endphp
                                        <td>
                                            <a class="btn btn-outline-gradient" target="_blank" href="{{ route('collector.claim-details', $claim->id) }}">
                                                <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 576 512" height="16" width="16" xmlns="http://www.w3.org/2000/svg">
