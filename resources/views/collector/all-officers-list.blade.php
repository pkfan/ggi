    ...
    <div class="app-content content ">
        ...
        <div class="content-wrapper container-xxl p-0">
            ...
            <div class="content-body">
                <div class="row">
                    <div class="col-12">
                        <h4>@lang('language.ALL Officers')</h4>
                    </div>
                </div>
                            ...
                            <div class="card-header">
                                ...
                                <div class=" col-md-6  mb-1">
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <a href="{{ route('supervisor.register.officer') }}"> <button type="button"
                                                class="btn btn-primary">@lang('language.Register New Officer')</button></a>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($officers as $officer)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($officer->status == 0)
                                                            <a href="{{ url('admin/de-active/user/' . $officer->id) }}"
                                                                class="btn btn-danger">Not Active</a>
                                                        @else
                                                            <a href="{{ url('admin/active/user/' . $officer->id) }}"
                                                                class="btn btn-success">Active</a>
                                                        @endif
                                                    </td>
                                                    <td>{{ $officer->created_at }}</td>
                                                    {{-- <td>
                                                        <a href="{{ url('admin/edit-employee/' . $officer->id) }}"
                                                            class="btn btn-outline-danger">Edit</a>
                                                    </td> --}}
                                                    <td>
                                                        <a href="{{route('supervisor.set.officer.targets', ['officer_id'=>$officer->id])}}"
                                                            class="btn btn-outline-danger">set targets</a>
                                                    </td>
                                                </tr>
                                                <?php
                                                $count++;
