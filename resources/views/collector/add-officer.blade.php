                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">
                                        ...
                                        @lang('language.Register New Officer')</h4>
                                </div>
                                <div class="card-body">
                                    <form class="form" method="POST" action="{{ route('supervisor.register.officer') }}">
                                        @csrf
                                        <input type="hidden" class="custom-control-input" name="role" value="officer"
                                            id="officer-role">
                                        <div class="row">
