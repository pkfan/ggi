    ...
    <div class="row">
        ...
        <table class="table table-borderless" style=" border: 1px solid #e1e0e0;">
            ...
            <tbody style=" background: #f5f5f5;">
                ...
                <tr style="padding-left: 61px;">
                    <td style="width: 200px; padding-left: 32px;">
                        <span class="font-weight-bolder">Recovered Amount</span>
                    </td>
                    <td style="border-right: 1px solid #d3d2d2;width: 200px;">
                        <span class="font-weight-bolder">{{ $recoverdClaimAmount }}
                            ({{ $recoverdClaimAmountPercent }}%)</span>
                    </td>
                    <td style="width: 200px; padding-left: 32px;">
                        <span class="font-weight-bolder">@lang('language.Vehicle Make') </span>
                    </td>
                    <td style="width: 200px; ">
                        <span
                            class="font-weight-bolder">{{ $claim->claimData?->vehicle_make }}</span>
                    </td>
                </tr>
                <tr style="padding-left: 61px;">
                    <td style="width: 200px; padding-left: 32px;">
                        <span class="font-weight-bolder">Remaining Amount</span>
                    </td>
                    <td style="border-right: 1px solid #d3d2d2;width: 200px;">
                        <span class="font-weight-bolder">{{ $remainingClaimAmount }}
                            ({{ $remainingClaimAmountPercent }}%)</span>
                    </td>
                    <td style="width: 200px; padding-left: 32px;">
                        <span class="font-weight-bolder">@lang('language.Vehicle Type') </span>
                    </td>
                    <td style="width: 200px; ">
                        <span
                            class="font-weight-bolder">{{ $claim->claimData?->vehicle_type }}</span>
                    </td>
                </tr>
                {{-- //////////////////// --}}
                <tr style="padding-left: 61px;">
                ...
                <tr style="padding-left: 61px;">
                    ...
                    <td style="width: 200px; padding-left: 32px;">
                        <span class="font-weight-bolder">Art Remarks</span>
                    </td>
                    <td style="width: 200px; ">
                        <span
                ...
                <tr style="padding-left: 61px;">
                    <td style="width: 200px; padding-left: 32px;">
                        <span class="font-weight-bolder">Debtor Type</span>
                    </td>
                    <td style="border-right: 1px solid #d3d2d2;width: 200px;">
                        <span class="font-weight-bolder">{{ $claim->deb_type }}</span>
                    </td>
                    <td style="width: 200px; padding-left: 32px;">
