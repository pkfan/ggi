    ...
    var dt_basic = dt_basic_table.DataTable({
      ...
      buttons: [
...

        {
          ...
          text: feather.icons['share'] + 'Un Verified Selected',
        ...
        {
          text: 'Verified Selected',
          className: 'create-new btn btn-outline-success',
          attr: {
            'data-toggle': 'modal',
      ...
      columnDefs: [
        {
          ...
          render: function (data, type, full, meta) {
            ...
            var $status = {
              ...
              2: { title: 'Un Verified', class: ' badge-light-danger' },
